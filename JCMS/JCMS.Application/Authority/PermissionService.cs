...
{
    //public class PermissionService : AsyncCrudAppService<Abp.Authorization.Permission, PermissionDto, int, PagedResultRequestDto, PermissionDto, PermissionDto>, IPermissionService
    //{
    //    public PermissionService(IRepository<Abp.Authorization.Permission, int> repository) : base(repository)
    //    {
    //    }
    //}
